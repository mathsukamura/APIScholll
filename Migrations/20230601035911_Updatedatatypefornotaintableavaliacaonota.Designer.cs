...
namespace Scholl.Migrations
{
    ...
    [Migration("20230601035911_Updatedatatypefornotaintableavaliacaonota")]
    partial class Updatedatatypefornotaintableavaliacaonota
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Scholl.HistoricoModel.Historico", b =>
                {
                    ...
                    b.Property<float>("NotaFinal1")
                        .HasColumnType("float")
                        .HasColumnName("notafinal1");

                    b.Property<float>("NotaFinal2")
                        .HasColumnType("float")
                        .HasColumnName("notafinal2");

                    b.Property<float>("NotaFinal3")
                        .HasColumnType("float")
                        .HasColumnName("notafinal3");

                    b.Property<float>("NotaFinal4")
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("Scholl.HistoricoModel.Historico", b =>
                {
                    b.HasOne("Scholl.AlunoModel.Aluno", "Aluno")
                        .WithOne("Historico")
                        .HasForeignKey("Scholl.HistoricoModel.Historico", "IdAluno")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
